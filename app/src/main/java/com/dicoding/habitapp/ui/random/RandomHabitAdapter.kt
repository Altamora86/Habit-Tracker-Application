...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val tvPriority : ImageView = itemView.findViewById(R.id.item_priority_level)
        private val btnDetail : Button = itemView.findViewById(R.id.btn_open_count_down)

        fun bind(pageType: PageType, pageData: Habit) {
            when (pageType) {
                PageType.HIGH -> {
                    tvPriority.setImageResource(R.drawable.ic_priority_high)
                }
                PageType.MEDIUM -> {
                    tvPriority.setImageResource(R.drawable.ic_priority_medium)
                }
                else -> {
                    tvPriority.setImageResource(R.drawable.ic_priority_low)
                }
            }
